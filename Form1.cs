    ...
    public partial class Form1 : Form
    {
        ...
        private void bIgual_Click(object sender, EventArgs e)
        {
            ...
            switch (operacion) {
                ...
                case 7:
                    resultadoBox.Text =resultadoBox.Text + " = " + log.Logaritmo(num1).ToString();
                    break;

                case 8:
                    resultadoBox.Text = resultadoBox.Text + " = " + elavado10.ElevarNum10(num1, num2).ToString();
                    break;

                case 9:
                    resultadoBox.Text = resultadoBox.Text + " = " + numElevado.NumElevado(num1, num2).ToString();
                    break;

                case 10:
                    resultadoBox.Text = resultadoBox.Text + " = " + factorial.Factor(num1).ToString();
                    break;
        ...
        private void BlogaritmoDeNum_Click(object sender, EventArgs e)
        {
            operacion = 7;
            num1 = double.Parse(resultadoBox.Text);
            resultadoBox.Text = resultadoBox.Text + "Log";
            activacion = true;
        }
        ...
        private void BdiezElevadoNum_Click(object sender, EventArgs e)
        {
            operacion = 8;
            num1 = double.Parse(resultadoBox.Text);
            resultadoBox.Text = resultadoBox.Text + "x10";
            activacion = true;
        }
        ...
        private void Bfactorial_Click(object sender, EventArgs e)
        {
            operacion = 10;
            num1 = double.Parse(resultadoBox.Text);
            resultadoBox.Text = resultadoBox.Text + "n!";
            activacion = true;
        }
